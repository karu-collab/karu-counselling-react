...
export default function Header() {
    ...
    const { user, isAuthenticated, logout, isLoading } = useAuth(); // Add isLoading
    // Remove redundant currentUser state - use user directly
                    ...
                    <div className={styles.userSection}>
                        {isAuthenticated ? (
                            ...
                            <div className={styles.authenticatedUser}>
                                {/* User Info - Use user directly, not currentUser */}
                                <motion.div
                ...
                <div className={styles.mobileNavContent}>
                    ...
                    {isAuthenticated ? (
                        <motion.button
                            initial={{ x: -20, opacity: 0 }}
                            animate={{ x: 0, opacity: 1 }}
                            transition={{ delay: navItems.length * 0.1 }} // Fixed: was 'navigation'
                            onClick={handleLogout}
                        ...
                        <div className={styles.mobileAuthSection}>
                            ...
                            >
                                <Link
                                    to="/login"
                                    onClick={() => setIsMobileMenuOpen(false)} // Fixed: was isMobileMenuOpen(false)
